...
const Home = () => {
    return (
        <div className="container-fluid home">
            ...
            <img className="container-fluid main-image" src={require('../images/Home-thin.png')} alt="logo"></img>
            ...
            <div className="home-text">
                <div className="container wrapper icon-text">
                    ...
                    <Link className="link" onClick={() => {
                        ...
                        <img src="https://image.flaticon.com/icons/svg/1250/1250616.svg" className="icon" alt="create"></img>
                            <p>Create a recipe.</p>
                        </Link>
                    ...
                    <Link to="/recipes" className="link">
                        <img src="https://i.pinimg.com/originals/e4/4c/57/e44c577196d295eb166d7455078f5ca9.png" className="icon" alt="existing recipes"></img>
